...
impl UserInterface {
    pub fn make_window() -> Self {
        let mut fl2rust_widget_0 = Window::new(616, 196, 628, 505, "");
        fl2rust_widget_0.end();
        fl2rust_widget_0.show();
        let mut fl2rust_widget_1 = Tabs::new(4, 10, 634, 515, "");
        ...
        let mut fl2rust_widget_10 = Input::new(30, 348, 119, 30, "");
        fl2rust_widget_2.add(&fl2rust_widget_10);
        let mut fl2rust_widget_11 = Output::new(30, 390, 119, 30, "");
        ...
        let mut fl2rust_widget_17 = Scrollbar::new(180, 440, 415, 20, "");
        fl2rust_widget_17.set_type(ScrollbarType::Horizontal);
        fl2rust_widget_2.add(&fl2rust_widget_17);
        let mut fl2rust_widget_18 = FileBrowser::new(390, 240, 190, 150, "");
